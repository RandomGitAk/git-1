...
<div style="padding: 20px">
    ...
    <h1><fmt:message key="genre.form"/></h1>
    <div class="row">
        <div class="col-sm-4">
            <form method="post" action="/users/genre">
                </br>
                <div align="left">
                    <label for="name_gen" class="form-label"><fmt:message key="add.genre"/></label>
                    <input type="text" class="form-control" placeholder=<fmt:message key="add.genre"/>  name="name_gen" id="name_gen"
                           required>
                </div>
